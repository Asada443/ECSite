            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvProductName" runat="server" ControlToValidate="txtProductName" ErrorMessage="商品名を入力してください" Text="*" ForeColor="Red" />
                    </td>
                </tr>
                <tr>
                    <td>価格：</td>
                    <td>
                        <asp:TextBox ID="txtPrice" runat="server" Width="100px"></asp:TextBox> 円
