...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <%--Enableは古いエラーメッセージなどはが残らないようにするためのやつ--%>
            <br />
            <br />
            ...
            <table border="0">
                ...
                <tr>
                    <td>移住枠：</td>
                    <td>
                        <asp:TextBox ID="txtStock" runat="server" TextMode="Number" Width="100px"></asp:TextBox>
                        個
                    </td>
                </tr>
                <tr>
            ...
            <asp:Button ID="btnBack" runat="server" Text="商品管理一覧に戻る" OnClick="btnBack_Click" UseSubmitBehavior="false" /><%--ただの画面遷移--%>
        </div>
    </form>
</body>
</html>
